...
const ccpPath = '/home/ishan/fabric-samples/bankchain/connection-banka.json';
...
async function submitTrans ( txID, trans, hasharray) {
		...
		const wallet = new FileSystemWallet('/home/ishan/fabric-samples/bankchain/wallet-BankA');
